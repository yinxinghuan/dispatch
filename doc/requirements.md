...
Dispatch 是一个 `other` 类型的移动端小游戏：1994 年凌晨 3:47 芝加哥 911 调度台。夜班警员 Marcus, 38, 第 6 小时一通电话没接到, 屏上 5 条未听语音, 都是陌生人报警说今晚各处遇到一个崩溃的男人。点 5 条听完。高潮: 第 6 条是 Marcus 本人 30 天前妻子中风死那晚打的 911, 此刻他终于接起。全程无人脸, 整屏磷绿 CRT 终端。AlterU After Dark FMV 第 7 作。

## 2. Visual Design

- 整体布局：页面占用 100vw x 100vh，主体验居中，HUD 与操作区覆盖在游戏层上方，移动端以单手操作为优先。
- 背景与配色：主要颜色使用 #000、rgba(51, 255, 102, 0.65)、#33ff66、rgba(0, 8, 0, 0.55)、rgba(51, 255, 102, 0.7)、rgba(0, 0, 0, 0.95)、rgba(51, 255, 102, 0.25)、rgba(0, 4, 0, 0.55)；高亮元素用于可点击目标、得分、结果或稀有状态。
- 字体：使用 'Cormorant Garamond', ui-serif, Georgia, 'Times New Roman', serif、'Px437 IBM VGA 8x16', 'IBM Plex Mono', 'Menlo', 'Courier New', monospace、'Px437 IBM VGA 8x16', 'IBM Plex Mono', 'Menlo', monospace、inherit，按钮与状态文字保持 12-24 px 的可读范围。
...
- 美术素材清单：
- clip_05_supv.mp4：视频素材，用于角色、场景、封面、反馈或品牌视觉。
- clip_03_payphone.mp4：视频素材，用于角色、场景、封面、反馈或品牌视觉。
- clip_02_anon.mp4：视频素材，用于角色、场景、封面、反馈或品牌视觉。
- clip_04_sgt.mp4：视频素材，用于角色、场景、封面、反馈或品牌视觉。
- clip_06_climax.mp4：视频素材，用于角色、场景、封面、反馈或品牌视觉。
- clip_01_cab.mp4：视频素材，用于角色、场景、封面、反馈或品牌视觉。
